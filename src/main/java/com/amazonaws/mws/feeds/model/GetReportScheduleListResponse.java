...
@XmlRootElement(name = "GetReportScheduleListResponse")
public class GetReportScheduleListResponse {

    @XmlElement(name = "GetReportScheduleListResult", required = true)
    protected GetReportScheduleListResult getReportScheduleListResult;
     ...
     * Value constructor
     *
     * @param getReportScheduleListResult a {@link GetReportScheduleListResult} object.
     * @param responseMetadata a {@link ResponseMetadata} object.
     */
    public GetReportScheduleListResponse(final GetReportScheduleListResult getReportScheduleListResult, final ResponseMetadata responseMetadata) {
     ...
     */
    public GetReportScheduleListResult getGetReportScheduleListResult() {
        return getReportScheduleListResult;
    }
     ...
     * @param value
     *     allowed object is
     *     {@link GetReportScheduleListResult}
     */
    public void setGetReportScheduleListResult(GetReportScheduleListResult value) {
        this.getReportScheduleListResult = value;
    }

    /**
     * <p>isSetGetReportScheduleListResult.</p>
     *
     * @return a boolean.
     */
     ...
     * Sets the value of the GetReportScheduleListResult property.
     *
     * @param value a {@link GetReportScheduleListResult} object.
     * @return a {@link GetReportScheduleListResponse} object.
     */
    public GetReportScheduleListResponse withGetReportScheduleListResult(GetReportScheduleListResult value) {
        setGetReportScheduleListResult(value);
        return this;
    }
     ...
     * @return a {@link GetReportScheduleListResponse} object.
     */
    public GetReportScheduleListResponse withResponseMetadata(ResponseMetadata value) {
    ...
    public String toJSON() {
        ...
        if (isSetGetReportScheduleListResult()) {
            ...
            json.append("\"GetReportScheduleListResult\" : {");
            GetReportScheduleListResult getReportScheduleListResult = getGetReportScheduleListResult();

            json.append(getReportScheduleListResult.toJSONFragment());
            json.append("}");
            first = false;
        } 
        if (isSetResponseMetadata()) {
